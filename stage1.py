...
def main():
    ...
    parser.add_argument("--micro_batch", type=int, default=16, required=False)
    ...
    Din, Dout, Dmodel, Dff, Batch, Seq, Head, KVHead, Experts, KExperts, Dvocal, MicroBatch = (
        sp.symbols("Din Dout Dmodel Dff Batch Seq Head KVHead Experts KExperts Dvocal MicroBatch")
    )
    symbol_map_value = {
        Dvocal: args.dvocal,
        Dmodel: args.dmodel,
    ...
    if args.model_type == "dense":
        ...
        transformer_dense = MicroBatchReplicator.apply(transformer_dense, symbol_map_value)
        ...
        transformer_dense.save_tensor_graph("dense.csv")
        ...
        pipeline_tensor_map = _create_pipeline_tensor_map(
            transformer_dense.tensors, temporal_parallel_dims, symbol_map_value, num_stacks)
        ...
        # moe model
        pipeline_tensor_map = _create_pipeline_tensor_map(transformer_moe.tensors, temporal_parallel_dims, symbol_map_value, num_stacks)
