...
num_samples = 2048
et_dir = "./run_file/ets/2"
symbolic_dir = "../../sharding_spreadsheets/transformer/dp"
...
def convert_task(i_, design_space_, num_layers):
    ...
    os.makedirs(os.path.join(et_dir), exist_ok=True)
    ...
    converter = Symbolic2ChakraConverter(
        ...
        os.path.join(et_dir, f"transformer_{i_}"),
        symbol_value_map,
        256,
    )
